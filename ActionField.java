...
public class ActionField extends  JPanel{
   ...
   public  String getQuadrant(int x, int y) {
    ...
    public ActionField() throws Exception {
        ...
        bt7 = new BT7(this, battleField, 0, 0, Direction.RIGHT);
        tiger = new Tiger(this, battleField, 512, 0, Direction.LEFT);
    ...
    protected void paintComponent(Graphics g) {
        ...
        g.fillRect(tank.getX(), tank.getY(), 64, 64);
         ...
         g.setColor(new Color(54, 142, 144));
         g.fillRect(bt7.getX(), bt7.getY(), 64, 64);
         g.setColor(new Color(0, 255, 0));
         if (bt7.getDirection() == Direction.UP) {
             g.fillRect(bt7.getX() + 20, bt7.getY(), 24, 34);
         } else if (bt7.getDirection() == Direction.DOWN) {
             g.fillRect(bt7.getX() + 20, bt7.getY() + 30, 24, 34);
         } else if (bt7.getDirection() == Direction.LEFT) {
             g.fillRect(bt7.getX(), bt7.getY() + 20, 34, 24);
         } else {
             g.fillRect(bt7.getX() + 30, bt7.getY() + 20, 34, 24);
         }
